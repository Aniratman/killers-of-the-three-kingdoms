...
export const StageHandler: StringIndexSet<Function> = {
    registerStageEvents: function registerStageEvents(this: any) {
        theGameManager.addEventListener(GameStage.GAME_PREPARE, this, this.handleGamePrepare);
    ...
    handleGamePrepare: function handleGamePrepare(this: GamePlayer, player: GamePlayer) {
